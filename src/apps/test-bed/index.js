...
withDebug(app)({
  ...
  view: state => h('article', null, [
    ...
    h('article', null, [
      h('p', null, 'Welcome to the hyperapp debug dev tool test bed application.'),
      h('p', null, [
        `If you don't have it already, install the `,
        h('a', { href: 'https://addons.mozilla.org/en-US/firefox/addon/hyperapp-debug-dev-tools/', target: '_blank' }, 'firefox extension'),
        '. ',
        `Once that's installed, open up your dev tools, and play with the app.`,
        `You'll see you can debug actions, effects, and subscriptions, and more importantly, time travel the state of the application.`,
      ]),
    ]),
